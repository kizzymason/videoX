...
export const contentApi = {
  videos: (query: VideoListQuery) => api.get<Paginated<VideoSummary>>('/videos', { ...query }),
...
export const socialApi = {
  ...
  following: (page = 1, pageSize = 30) => api.get<Paginated<PublicUser>>('/following', { page, pageSize }),
